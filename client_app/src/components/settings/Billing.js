          ...
          {isLoading ? (
            ...
            data.getAllPlans.map((plan, key) => (
              ...
              >
                ...
                {plan.name === "professional" && <p className="absolute top-0 -translate-y-1/2 bg-brightRed text-white px-3 py-0.5 rounded-full text-sm font-semibold tracking-wide shadow-md">Most Popular</p>}
